						...
						<div class="ctn_tbl_area">
							<div class="ctn_tbl_row">
								...
								<div class="ctn_tbl_td">
									<input type="text" id="authDefine" name ="authDefine" placeholder="" class="form-control input_base_require" required>
								</div>
								<div class="ctn_tbl_th ">권한 값</div>
								<div class="ctn_tbl_td">
									<input type="text" id="authLevel" name ="authLevel" placeholder="" class="form-control input_base_require" required>
								</div>
							</div>
							<div class="ctn_tbl_row">
							...
							<div class="ctn_tbl_row">
								<div class="ctn_tbl_th ">권한 사용 여부</div>
								<div class="ctn_tbl_td">
									<select name ="usedYn">
