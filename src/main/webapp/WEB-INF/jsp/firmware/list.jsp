...
<script>
	...
	$(document).ready(function(){
		...
		var tb2=$("#tableList").DataTable({
            ...
            columns: [
                ...
                {data:"regDt"},
                {
            		data:   "fileId",
                	"render": function (data, type, row, meta) {
                        return '<a href="/fileDownload.ajax?fileId='+data+'">다운로드</a>';
                    }
                }
            ],
		...
		$("#btnInsert").click(function() {
			location.href="/firmware/insert.do";
		});
		...
		/* $("#tableList").on("click", "tbody td:not(':first-child')", function(){
			...
			$(this).attr('id');
			if(tagId!="chkTd"){
				$("#contents").load("/firmware/detail.do",{"departCode":tagId}); 
			}
		}); */
		...
		<div id="contents" class="contents-wrap">
			...
			<div id="work" class="work-wrap list_page">
				<div class="ctn_tbl_header">
					<div class="ttl_ctn">펌웨어 업로드 목록</div>
				</div>
                <!-- search_box Start -->
